        ...
        if (arSceneView.session == null) {
            ...
            try {
                ...
                if (session == null) {
                    ...
                    // arSceneView.setupSession(session) - Removed in 1.23.0, setting session directly if possible, or it's handled internally. Wait, actually I will just do:
                    try { arSceneView.session = session } catch (e: Exception) {}
                }
